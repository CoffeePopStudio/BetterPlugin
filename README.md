...
dependencies {
    compileOnly("com.github.CoffeePopStudio:BetterPlugin:26.9.0-mc26.1.2")
}
```

Build status and available versions: <https://jitpack.io/#CoffeePopStudio/BetterPlugin/26.9.0-mc26.1.2>
