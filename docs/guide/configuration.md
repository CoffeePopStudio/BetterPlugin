...
- `depend` declares the runtime dependency `BetterPlugin` (for the compile-time dependency, see [Integration](/guide/third-party); JitPack is the recommended way to get it)
